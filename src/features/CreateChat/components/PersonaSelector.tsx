...
import type { UserPersona, GameModeType } from '@/core/types/chat'
          ...
          {selectedPersona ? (
            <>
              <div className={styles.personaAvatarSquare}>
                <img src={selectedPersona.avatar_url || undefined} alt="Avatar" />
              </div>
        ...
        {isOpen && (
          <div className={styles.personaDropdown}>
            ...
            {personas.map(persona => (
              ...
              >
                <div className={styles.personaAvatarSquare}>
                  <img src={persona.avatar_url || undefined} alt={persona.name} />
                </div>
                <div className={styles.personaContent}>
                  <div className={styles.personaHeader}>
